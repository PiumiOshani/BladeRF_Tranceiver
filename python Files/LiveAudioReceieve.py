...
class audioReceieve(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "audioReceieve")
        ...
        self.soapy_bladerf_source_0.set_sample_rate(0, 2.048e6)
        self.soapy_bladerf_source_0.set_bandwidth(0, 200e3)
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            '/home/gnuradio/ReceivedFiles/audio.wav',
            1,
            samp_rate,
            blocks.FORMAT_WAV,
        ...
        self.connect((self.soapy_bladerf_source_0, 0), (self.rational_resampler_xxx_0_0, 0))
...
def main(top_block_cls=audioReceieve, options=None):
