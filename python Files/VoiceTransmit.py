...
class audiosourceTransmit(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "audiosourceTransmit")
...
def main(top_block_cls=audiosourceTransmit, options=None):
