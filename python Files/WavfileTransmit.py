...
input_audio_file = os.environ.get('AUDIO_FILE')
...
class wavfileTransmit(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "wavfileTransmit")
        ...
        self.soapy_bladerf_sink_0.set_sample_rate(0, 2.048e6)
        self.soapy_bladerf_sink_0.set_bandwidth(0, 30000)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source(input_audio_file, True)
...
def main(top_block_cls=wavfileTransmit, options=None):
